...
class __TwigTemplate_641d238c1ff4857217d97bbb5bbd080f31c818129240b344d158fcc44f184ab6 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
                ...
                <div class=\"card\">
                    ...
                    // line 233
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_array_filter(twig_get_attribute($this->env, $this->source, $context["message"], "children", [], "any", false, false, false, 233), function ($__messagePart__) use ($context, $macros) { $context["messagePart"] = $__messagePart__; return twig_in_filter(twig_get_attribute($this->env, $this->source, $context["messagePart"], "contentType", [], "any", false, false, false, 233), [0 => "text/plain", 1 => "text/html"]); }));
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Swiftmailer/Collector/swiftmailer.html.twig", "/opt/lampp/htdocs/mooc-symfony4/vendor/symfony/swiftmailer-bundle/Resources/views/Collector/swiftmailer.html.twig");
    }
}
